#
# Be sure to run `pod lib lint NudgespotiOSSDK.podspec' to ensure this is a
...
s.resource_bundles = {
'NudgespotiOSSDK' => ['Pod/Assets/*.png']
}

s.prefix_header_file = "Example/Pods/Target\ Support\ Files/NudgespotiOSSDK/NudgespotiOSSDK-prefix.pch"
